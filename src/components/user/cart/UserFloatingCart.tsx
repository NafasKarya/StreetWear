          ...
          >
            ...
            <div className="mt-6 border-t border-white/20 pt-4">
              ...
              <button
                onClick={() => {
                  setOpenCart(false);
                  router.push("/user/checkout"); // ⬅️ redirect ke halaman checkout
                }}
                className="w-full py-3 rounded-xl bg-emerald-500/80 hover:bg-emerald-600 text-white font-bold transition shadow-lg"
              >
                Checkout
              </button>
            </div>
