...
const CATEGORIES = [
  {
    id: 1,
    title: "Streetwear",
    description: "Latest streetwear collections.",
    image: "/assets/images/admin-bg.png",
  },
  {
    id: 2,
    title: "Accessories",
    description: "Caps, bags, and stylish add-ons.",
    image: "/assets/images/admin-bg2.png",
  },
  {
    id: 3,
    title: "Sneakers",
    description: "Hyped shoes for your daily fit.",
...
export default function CardDetailCategoryUser() {
  return (
